...
public class AddressBook extends JFrame implements ActionListener
{
    ...
    private JButton
    first = new JButton("First"),            // For "move to first contact" action
    previous = new JButton("< Previous"),          // For "move to previous contact" action
    next = new JButton("Next >"),              // For "move to next contact" action
    last = new JButton("Last");             // For "move to final contact" action
    ...
    private void setUpAddressBook()
    {
        ...
        addContact("Sohail", "H.No.795/4,Opp.Darul Masjid,Badlapur Goan, BDl(West.) Pincode-421503,Thane,Maharashtra,India.", "8796504980", "sohailshaikh1432@gmail.com");
